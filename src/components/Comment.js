            ...
            <ul className="delete-popup" style={{ listStyle: "none" }}>
              <li>
                <form
                  ...
                  action={`https://rishi-twitter-api.onrender.com/deleteComment/${commentId}`}
                ...
                >
                  <div className="comment-modal">
                    <form
                      ...
                      action={`https://rishi-twitter-api.onrender.com/editComment/${commentId}`}
                    >
                      <input
                        required
                        autoFocus
      ...
      <div className="icons">
        <div style={{ color: btnColor }} className="icon">
          <form
            ...
            className="likeForm"
            action={`https://rishi-twitter-api.onrender.com/comment/${props.user}/like/${commentId}`}
            method="post"
          >
            <button>
              <AiOutlineLike />
