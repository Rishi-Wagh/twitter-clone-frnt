...
function Feed() {
  ...
  async function populateTweets() {
    const req = await fetch("https://rishi-twitter-api.onrender.com/feed", {
      headers: {
  ...
  async function addTweets(e) {
    e.preventDefault();
    const req = await fetch(`https://rishi-twitter-api.onrender.com/feed?t=${tweetCount}`, {
      headers: {
        "x-access-token": localStorage.getItem("token"),
      },
    });
    ...
    <div>
      <div className="form-flex">
        <img
          ...
          src={`https://rishi-twitter-api.onrender.com/images/${userAvatar}`}
        ></img>
        ...
        <form
          ...
          action="https://rishi-twitter-api.onrender.com/feed"
