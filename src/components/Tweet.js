...
function Tweet(props) {
  ...
  async function populateComments() {
    const req = await fetch(`https://rishi-twitter-api.onrender.com/feed/comments/${tweetId}`, {
      headers: {
          ...
          <li className="tweet-items">
            ...
            <div className="parent-flex-introduction">
              <img
                ...
                src={`https://rishi-twitter-api.onrender.com/images/${props.body.postedBy.avatar}`}
              ></img>
                    ...
                    <ul className="delete-popup" style={{ listStyle: "none" }}>
                      <li>
                        <form
                          ...
                          action={`https://rishi-twitter-api.onrender.com/deleteTweet/${tweetId}`}
                          ...
                          {(close) => (
                            <div className="comment-modal">
                              <form
                                ...
                                action={`https://rishi-twitter-api.onrender.com/editTweet/${tweetId}`}
                              >
                                <input
                                  required
                                  autoFocus
            ...
            <div className="icons">
              <div style={{ color: btnColor }} className="icon">
                <form
                  ...
                  className="likeForm"
                  action={`https://rishi-twitter-api.onrender.com/post/${props.user}/like/${tweetId}`}
                  method="post"
                >
                  <button>
                    <AiOutlineLike />
              ...
              <div style={{ color: retweetBtnColor }} className="icon retweet">
                <form
                  ...
                  action={`https://rishi-twitter-api.onrender.com/post/${props.user}/retweet/${tweetId}`}
                >
                  <button>
                    <AiOutlineRetweet />
                ...
                {(close) => (
                  <div className="comment-modal">
                    ...
                    <form
                      ...
                      method="post"
                      action={`https://rishi-twitter-api.onrender.com/feed/comment/${tweetId}`}
                    >
                      <input
                        autoFocus
                        required
